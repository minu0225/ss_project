...
<?php
        ...
        $sql.="values ('{$_SESSION['userid']}','{$_SESSION['username']}','{$_POST['title']}','{$_POST['write']}','$date','$upfile_name[0]','$upfile_name[1]','$upfile_name[2]','$copied_file_name[0]','$copied_file_name[1]','$copied_file_name[2]')";
        $connect->query($sql);
